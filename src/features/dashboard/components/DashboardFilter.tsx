...
export function DashboardFilter({ className, ...props }: React.ComponentProps<'div'>) {
	return (
		<div
...
export function DashboardFilterButton({ className, ...props }: React.ComponentProps<'button'>) {
	return (
		<Button
			variant={'ghost'}
			size={'xs'}
