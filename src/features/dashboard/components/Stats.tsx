...
function StatsDescription({ className, ...props }: React.ComponentProps<'div'>) {
	return (
		<div
...
function StatsContent({ className, ...props }: React.ComponentProps<'div'>) {
	return (
		<div data-slot="stats-content" className={cn('p-6 pt-0 text-4xl', className)} {...props} />
	);
}
...
export { Stats, StatsContent, StatsDescription, StatsFooter, StatsHeader, StatsTitle };
