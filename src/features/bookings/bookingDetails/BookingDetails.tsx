...
export const BookingDetailsList = ({ className, ...props }: React.ComponentProps<'ul'>) => {
	return (
		<ul
...
export const BookingDetailsListItem = ({ className, ...props }: React.ComponentProps<'li'>) => {
	return (
		<li
			...
			<Card>
				...
				<CardContent className="flex flex-col gap-6 py-10">
					<BookingDetailsList>
						...
						<BookingDetailsListItem>
							{booking?.guestId?.nationalID ? `National ID: ${booking?.guestId.nationalID}` : null}
						</BookingDetailsListItem>
					</BookingDetailsList>
					...
					>
						...
						<div className="flex grow items-center gap-2">
							...
							<span className="font-bold">{`${formatCurrency(booking.totalPrice || 0)} `}</span>
