...
export const BookingsStatusFilterSchema = BookingsStatusSchema.or(z.literal('all'));
...
export const createPaginationSchema = <TZodObject extends z.ZodObject<any>>(schema: TZodObject) =>
	z.object({
...
>;
// eslint-disable-next-line @typescript-eslint/no-explicit-any
export type Pagination<TZodObject extends z.ZodObject<any>> = z.infer<PaginationSchema<TZodObject>>;
