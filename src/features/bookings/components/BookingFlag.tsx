...
export default function BookingFlag({ url, nationality, flagSize = 20 }: BookingFlagProps) {
	const { data: parsedUrl, success: urlSuccess, error: urlError } = z.string().url().safeParse(url);
