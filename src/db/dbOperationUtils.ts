import { ErrorCatalog, errorCatalog } from '@/lib/constants/errorCatalog';
import { MessageCatalog, messageCatalog } from '@/lib/constants/messageCatalog';
import { AppError, AppErrorInstance } from '@/lib/errors';
...
export type DbOperationCallback<T, Args extends unknown[]> = (
  ...args: Args
) => DbOperationCallbackResult<T>;

export type DbOperationFunction = <T, Args extends unknown[]>(
